<%@ Page Language="VB" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Scheduler.aspx.vb" Inherits="Training_Quiz.SchedulerModule" Title="Scheduler" %>

<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v21.1, Version=21.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dx" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" Training_Quiz.Model.SchedulerAppointment"
        TypeName=" Training_Quiz.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" Training_Quiz.Model.SchedulerResource"
        TypeName=" Training_Quiz.Model.ResourceDataSourceHelper"
